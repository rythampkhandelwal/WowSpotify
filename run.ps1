...
function Get-Link {
    ...
    switch ($mirror) {
        $true { return "https://github.com/rythampkhandelwal/WowSpotify" + $endlink }
        default { return "https://github.com/rythampkhandelwal/WowSpotify/main" + $endlink }
    }
}
...
if ($test_js) {
    ...
    if ($ch -eq 'y') { 
        $Url = "https://telegra.ph/WowSpotify-FAQ-09-19#Can-I-use-WowSpotify-and-Spicetify-together?"
        Start-Process $Url
    }
